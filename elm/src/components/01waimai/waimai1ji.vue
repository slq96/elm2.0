<template>
	<div class="waimai">
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<ul @click="xqone()" class="ul1">
						<li :key="index" v-for="(value,index) in spfl" v-if="index<8">
				...
				<div class="swiper-slide">
					<ul class="ul1">
						<li :key="index" v-for="(value,index) in spfl" v-if="index>7">
							<img :src="value.image_url" />
							<p>{{value.title}}</p>
						</li>
					</ul>
		...
		<div class="maishop">
			<p>附近商家</p>
			<ul class="ul2">
				<li :key="index" @click="jindian(value)" v-for="(value,index) in shop">
					<img :src="value.image_url" />
